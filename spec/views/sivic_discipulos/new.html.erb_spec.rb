...
describe "sivic_discipulos/new" do
  before(:each) do
    assign(:sivic_discipulo, stub_model(SivicDiscipulo,
      :sivic_pessoa => nil,
      :sivic_endereco => nil,
      :sivic_profissao => nil,
  ...
  it "renders new sivic_discipulo form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", sivic_discipulos_path, "post" do
