...
describe "sivic_relatorioscelulas/edit" do
  before(:each) do
  ...
  it "renders the edit sivic_relatorioscelula form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", sivic_relatorioscelula_path(@sivic_relatorioscelula), "post" do
