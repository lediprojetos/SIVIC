...
describe "sivic_contabancos/edit" do
  before(:each) do
  ...
  it "renders the edit sivic_contabanco form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", sivic_contabanco_path(@sivic_contabanco), "post" do
