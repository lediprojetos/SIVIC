class SivicAtividadepessoasController < ApplicationController
  before_action :set_sivic_atividadepessoa, only: [:show, :edit, :update, :destroy]
  ...
  private
    ...
    def sivic_atividadepessoa_params
      params.require(:sivic_atividadepessoa).permit(:flag_ativo, :data_exclusao, :data_bloqueio, :sivic_atividade_id, :sivic_igreja_id, :sivic_pessoa_id, :User_id)
    end
end
